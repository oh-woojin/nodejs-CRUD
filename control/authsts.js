...
module.exports = {
    ...
    StatusUI: function(req, res){
        var authStatusUI = `
        <li class="nav-item"><a class="nav-link" id="hover-menu" href="/auth/login">로그인</a></li>
        <li class="nav-item"><a class="nav-link" id="hover-menu" href="/auth/join">회원가입</a></li>`
        if(this.IsOwner(req, res)){
          authStatusUI = `<span class="navbar-text" id="username">${sanitize(req.session.name)}님 </span>
            <li class="nav-item"><a class="nav-link" id="hover-menu" href="/auth/logout">로그아웃</a></li>
            <li class="nav-item"><a class="nav-link" id="hover-menu" href="/auth/mypage">마이페이지</a></li>`
        }
        return authStatusUI;
      },
